...
@Component({
  ...
  template: `
    ...
    >
      <g clip-path="url(#clip0_20010_4494)">
        <path
          d="M8.75 13.3837L5.625 10.2581L6.50813 9.375L8.75 11.6163L13.4906 6.875L14.375 7.75937L8.75 13.3837Z"
          [attr.fill]="fillColor"
        />
        <path
      ...
      <defs>
        <clipPath id="clip0_20010_4494">
          <rect width="20" height="20" [attr.fill]="fillColor" />
        </clipPath>
      </defs>
    </svg>
  `,
})
export class CheckMarkSvg {
  @Input('fillColor') fillColor: string = '#FFFFFF';
}
